...
/** Configuration for an IPv6 address family */
@ParametersAreNonnullByDefault
public final class Ipv6UnicastAddressFamily extends AddressFamily {

  private Ipv6UnicastAddressFamily(
  ...
  @JsonCreator
  private static Ipv6UnicastAddressFamily jsonCreator(
      // super fields
    ...
    return new Ipv6UnicastAddressFamily(
        addressFamilyCapabilities,
        exportPolicy,
  ...
  public boolean equals(@Nullable Object o) {
    ...
    if (!(o instanceof Ipv6UnicastAddressFamily)) {
      return false;
    }
    Ipv6UnicastAddressFamily that = (Ipv6UnicastAddressFamily) o;
  ...
  public static final class Builder
      extends AddressFamily.Builder<Builder, Ipv6UnicastAddressFamily> {
    ...
    @Override
    public @Nonnull Ipv6UnicastAddressFamily build() {
      checkArgument(
