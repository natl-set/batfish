...
public class PaloAltoConfigurationBuilder extends PaloAltoParserBaseListener
  ...
  /**
   * Check if a string is a valid geolocation code (ISO 3166-1 alpha-2 country code or special
   * codes like A1, A2, EU, AP, etc.)
   */
  private boolean isGeolocationCode(String text) {
    ...
    if ("A1".equals(text) || "A2".equals(text) || "EU".equals(text) || "AP".equals(text)
        || "CE".equals(text) || "DN".equals(text) || "LN".equals(text)) {
      return true;
    }
