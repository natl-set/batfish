...
public class FtdGrammarBenchmarkTest extends FtdGrammarTest {
  ...
  private int measureIterations;

  @Before
  public void setup() {
    warmupIterations = Integer.getInteger("benchmark.warmup", 3);
    measureIterations = Integer.getInteger("benchmark.iterations", 5);
  }
  ...
  private BenchmarkResults runBenchmark(String name, String config) {
    ...
    return new BenchmarkResults(
        name,
        totalParseTime / measureIterations,
        totalTokens / measureIterations,
        lineCount,
        charCount);
  }
